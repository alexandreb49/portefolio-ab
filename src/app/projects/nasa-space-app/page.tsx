// app/components/ImfReconnectionApp.jsx
...
function ImfReconnectionApp() {
  ...
  const tech = [
    { icon: <Satellite className="text-blue-600" />, label: "ACE & DSCOVR (NASA) data" },
    { icon: <Cloud className="text-blue-600" />, label: "OMNIWeb downloads & preprocessing" },
    { icon: <Database className="text-blue-600" />, label: "Data cleaning (remove sentinel values 9999.99)" },
    ...
    { icon: <Code2 className="text-blue-600" />, label: "VS Code for development" },
    { icon: <GitBranch className="text-blue-600" />, label: "GitHub repo & versioning" },
    { icon: <Globe className="text-blue-600" />, label: "Website for inference & demos" },
  ];
