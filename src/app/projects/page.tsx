...
function MyProjects() {
  const projects: Project[] = [
    { title: 'BMG machining Study', link: '/projects/bmg-machining',image_class :'bmg' },
    {
      title: 'Finite element analysis software',
      link: '/projects/finite-element-analysis-app',
      image_class :'software'
    },
    { title: 'Inductive sensor', link: '/projects/inductive-sensor', image_class: 'parking' },
    { title: 'NASA space app challenge 2023', link: '/projects/nasa-space-app', image_class : 'space' },
  ]
